...
namespace MarekSkopal\MsFaq\Hooks;
...
class ItemsProcFunc
{
    ...
    {
        /** @var array{"tx_msfaq."?: array{"templateLayouts."?: array<string, string>}} $pagesTsConfig */
        $pagesTsConfig = BackendUtility::getPagesTSconfig($pageUid);

        return $pagesTsConfig['tx_msfaq.']['templateLayouts.'] ?? [];
    }
    ...
    private function getTemplateLayoutsFromGlobals(): array
    {
         ...
         */
        $templateLayouts = $GLOBALS['TYPO3_CONF_VARS']['EXT']['ms_faq']['templateLayouts'] ?? [];
